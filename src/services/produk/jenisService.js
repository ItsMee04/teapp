// src/services/usermanagement/jenisService.js
...
export const jenisService = {
    ...
    async getJenis() {
        try {
            const response = await api.get("/jenisproduk/getJenisProduk");
    ...
    async storeJenis(formData) {
        try {
            const response = await api.post("/jenisproduk/storeJenisProduk", formData, {
                headers: {
    ...
    async updateJenis(id, formData) {
        try {
            ...
            const response = await api.post(
                `/jenisproduk/updateJenisProduk/${id}`,
                formData,
                {
                    headers: {
                        "Content-Type": "multipart/form-data",
    ...
    async deleteJenis(id) {
        try {
            const response = await api.delete(`/jenisproduk/deleteJenisProduk/${id}`);
            return response.data;
        } catch (error) {

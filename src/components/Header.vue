<template>
    <div>
        ...
        <div class="header">
            ...
            <a id="mobile_btn" class="mobile_btn" href="#sidebar" @click.prevent="toggleMobileMenu">
                <span class="bar-icon">
                    <span></span>
                    <span></span>
                    <span></span>
                                    ...
                                    <ul class="customers">
                                        <li>
                                            <a href="javascript:void(0);">Aron Varu<img
                                                    src="/src/assets/img/profiles/avator1.jpg" alt=""
                                                    class="img-fluid"></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">Jonita<img
                                                    src="/src/assets/img/profiles/avatar-01.jpg" alt=""
                                                    class="img-fluid"></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">Aaron<img
                                                    src="/src/assets/img/profiles/avatar-10.jpg" alt=""
                                                    class="img-fluid"></a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <ul class="notification-list">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="/src/assets/img/profiles/avatar-03.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="/src/assets/img/profiles/avatar-06.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="/src/assets/img/profiles/avatar-17.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="/src/assets/img/profiles/avatar-13.jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
...
// ===== Hover expand menu for mini sidebar =====
const handleMouseOver = (e) => {
    if (isMiniSidebar.value) {
        ...
        if (target) {
            ...
            document.querySelectorAll('.subdrop + ul').forEach((ul) => {
